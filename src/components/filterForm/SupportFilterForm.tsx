...
function SupportFilterForm(prop: Prop) {
    ...
    const [propertyItems, _etPropertyItems] = useState<DropdownItem[]>([
        { label: "Dispositivo", code: "dev.description" },
        { label: "Cliente", code: "cus.name" },
        { label: "Fecha Inicio", code: "sup.start_date" },
        { label: "Fecha Fin", code: "sup.end_date" },
        { label: "Monto Total", code: "sup.total" },
    ]);
    ...
    return (
        <>
            ...
            <div className="filter-form-inputs">
                ...
                <div style={{ width: "440px", position: "absolute", bottom: "5px", right: "20px" }}>
                    <Button
