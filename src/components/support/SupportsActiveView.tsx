              ...
              <div key={id} className='target support-item'>
                  <section className='supp-item-text-con'>
                      <div className='supp-item-text-description'>
                          ...
                          <p style={{marginLeft:"5px"}}>{sup.categoryDev}</p> 
                      <div className="flex" style={{marginTop:"2px", color: "grey"}}>
                          <FaRegUser />
                          <p style={{marginLeft:"5px"}}>{sup.customer}</p>    
                      </div>
                      <div className="flex">
                          <VscTools className="title" style={{marginTop:"3px", color: "grey"}}/>
                          <p style={{marginLeft:"5px"}}>{sup.user}</p>
                      </div>
