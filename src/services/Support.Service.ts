...
import type { SupportCustomGet, SupportParams, SupportPost } from "../Interface/SupportIn";
...
export const getSupportsCustomByFilterRequest = (filter: string) => axios.get(API+"/custom/filter/"+filter)
...
export const getSupportReportRequest = (list: SupportCustomGet[]) => axios.post(API+"/report", list, {responseType:"blob"})

export const getDevicesAmountRequest = () => axios.get(API+"/deviceAmount")
