...
import type { ProductDetailPost, Sale, SaleDates, SaleGet, SaleParams } from "../Interface/SalesInterfaces"
...
export const getSaleReportRequest = (list: SaleGet[]) => axios.post(API+"/report", list, {responseType:"blob"})