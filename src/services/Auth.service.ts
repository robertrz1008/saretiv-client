...
export const updateUserRequest = (user: CreateUser) => axios.put(httpAuth+"/updateUser/1", user)
...
export const getUserByFilterRequest = (filter: string) => axios.get(httpAuth+`/users/${filter}`)
