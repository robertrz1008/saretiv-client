...
import type { SupportType, SupportTypeDTO, SupportTypeParams } from "../Interface/SupportIn";
...
export const getSupportTypeReportRequest = (list: SupportType[]) => axios.post(API+"/report", list, {responseType:"blob"})


export const getSupportTypeRevewRequest = (list: SupportType[]) => axios.post(API+"/revew", list)