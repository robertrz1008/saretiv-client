...
export const updateCustomerStatusRequest = (id: number, cus: Customer) => axios.put(API+`/status/${id}`, cus)
...
export const getCustomerReportRequest = (list: Customer[]) => axios.post(API+"/report", list, {responseType:"blob"})
