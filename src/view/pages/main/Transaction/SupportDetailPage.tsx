    ...
    return (
        <div className="main-con">
            <div className="target support-detail-con">
                <section>
                    <h3 className="title">{context.supportCurrent?.description}</h3>
                </section>

                 <section className="total-con" style={{backgroundColor:"100%"}}>
                        <h3>TOTAL: </h3> <h3>{context.supTotal}</h3>
                </section>

                <section className="supp-tables-con" style={{marginTop:"10px"}}>
                    <SupportActivities />
                    <SupportProducts />
                </section>
